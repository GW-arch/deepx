# PANDA: Pose-Aware NPU-Driven Digital Audio Interface for Contactless Musical Performance

![PANDA project icon generated by `tools/gen_report_figures.py`.](figures/panda_icon.png)
...
[1] PANDA / AI Air-Drum Pad repository artifact, `air_drum_pad/` in `git@github.com:GW-arch/deepx.git`: source code, tests, generated figures, instrument images, and recorded benchmark artifacts used to construct this self-contained report.
