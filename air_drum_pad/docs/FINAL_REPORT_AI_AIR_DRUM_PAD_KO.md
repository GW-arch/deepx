...
![PANDA 프로젝트 아이콘: `tools/gen_report_figures.py`로 생성.](figures/panda_icon.png)
...
[1] PANDA / AI Air-Drum Pad 저장소 산출물, `git@github.com:GW-arch/deepx.git`의 `air_drum_pad/`: 본 self-contained 보고서 작성에 사용한 소스 코드, 테스트, 생성 그림, 악기 이미지, 기록된 벤치마크 산출물.
